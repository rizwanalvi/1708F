  ...
  public  class Product
    {
        ...
        public Image ImgProduct { get; set; }
        public List<Product> getProductList() {
            _product = new List<Product>();
            _product.Add(new Product { ProductId=100,ProductName="LG Printer 1506",Brand="LG",Quantity=26,Price=5000,CategoryId=1,ImgProduct= Image.FromFile("C:/Users/rizwan/Source/Repos/1708F/PassingDataForm/PassingDataForm/images/data.jpg") });
