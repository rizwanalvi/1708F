<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminWork.master" AutoEventWireup="true" CodeFile="usersStory.aspx.cs" Inherits="AdminPanel_Default4" %>
          ...
          <asp:GridView ID="GridView1" class="table" AutoGenerateColumns="False" runat="server" Width="721px" OnRowUpdating="GridView1_RowUpdating">
              <Columns>
                  <asp:TemplateField HeaderText="ID">
                      <EditItemTemplate>
                          <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("auto_generated_id") %>'></asp:TextBox>
                      </EditItemTemplate>
                      <ItemTemplate>
