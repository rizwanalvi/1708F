<%@ Page Title="" Language="C#" MasterPageFile="~/AdminPanel/AdminWork.master" AutoEventWireup="true" CodeFile="Approveusers.aspx.cs" Inherits="AdminPanel_Default" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <section id="main-content">
      <section class="wrapper">
          ...
          <h1 style="margin-top:80px;">Approves User</h1>
          <br /><br />
          ...
          <asp:GridView ID="GridView1" class="table" AutoGenerateColumns="False" runat="server" Width="721px" OnRowUpdating="GridView1_RowUpdating">
              <Columns>
                  ...
                  <asp:TemplateField HeaderText="Operation">
                      ...
                      <ItemTemplate>
                          <asp:LinkButton CssClass="btn btn-success btn-round" ID="LinkButton2" runat="server" CommandName="Update" OnClick="LinkButton2_Click">Approve</asp:LinkButton>
